    ...
    <footer className="bg-card border-t py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-3">
              <a 
                ...
                className="w-10 h-10 bg-primary/10 hover:bg-primary/20 text-primary rounded-full flex items-center justify-center transition-smooth"
                aria-label="LinkedIn"
              >
                <LinkedInIcon />
              </a>
          ...
          {/* Quick Links — matches page section order */}
          <div>
